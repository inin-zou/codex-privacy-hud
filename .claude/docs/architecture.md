...
inside the first eligible observation transaction. Readers accept its
absence and never create it; present but incomplete or altered definitions
are refused. Existing accounting tables and generations remain unchanged.
