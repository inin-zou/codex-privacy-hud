...
- The tool must survive its own audit, on stated inputs: the committed self-audit corpus's clean half produces zero exposures and its planted half is found (`docs/self-audit.md`). *(The unconditional "running Privacy HUD on Privacy HUD produces zero exposures" was measured false — 88%, 100% and 100% of budget on three read-only source reviews.)*
